...
@Component({
  selector: 'app-gestion-garage-entretien',
  imports: [
    TableModule,
    IconFieldModule,
    ButtonModule,
  ...
  templateUrl: './gestion-garage-entretien.component.html',
  styleUrl: './gestion-garage-entretien.component.scss'
})
export class GestionGarageEntretienComponent {
  entretiens = [
    { id: 'E001', nom: 'Peinture', prixUnitaire: 500, specialite: { id: 4, nom: 'Peinture Automobile' } },
    { id: 'E002', nom: 'Vidange', prixUnitaire: 350, specialite: { id: 1, nom: 'Mécanique Générale' } },
    { id: 'E003', nom: 'Pneu', prixUnitaire: 175, specialite: { id: 1, nom: 'Mécanique Générale' } },
    { id: 'E004', nom: 'Lavage', prixUnitaire: 75, specialite: { id: 3, nom: 'Carrosserie' } },
    { id: 'E005', nom: 'Essuie glace', prixUnitaire: 100, specialite: { id: 3, nom: 'Carrosserie' } }
  ];
